...
<head>
   ...
   <link rel="stylesheet" href="../static/admin_css/admin_board_list.css">
					...
					<table>
						...
						<%
								...
								for (Board board : boardList) {
									if (category == null && searchNo == null) {
										...
										<tr>
											<td><%=board.getNo()%>.</td>
											<td><a href="<%= request.getContextPath()%>/admin/read.jsp?no=<%=board.getNo()%>">[<%=board.getCategory() %>]
													<%= board.getTitle() %></a></td>
						...
						%>
										<tr>
											<td><%=board.getNo()%>.</td>
											<td><a
												href="<%= request.getContextPath()%>/admin/read.jsp?no=<%=board.getNo()%>">[<%=board.getCategory() %>]
													<%= board.getTitle() %></a></td>
											<td><%= board.getUser_id() %></td>
											<td><%= simpleDate.format(board.getReg_date()) %></td>
										</tr>
